...
- Source file: `data/cleaned-biofood-date-region.csv`
- Source dataset: https://www.fao.org/infoods/infoods/tables-and-databases/faoinfoods-databases/en/
- Features (5): Water, Potassium, Iron, Calcium, Magnesium
- Rows after cleaning: 77 — split into 53 train / 24 test (`TEST_SIZE=0.3`)
...
![Uncertainty calibration reliability curve](../../results/biofood_date_region/figures/marginals/coverage_calibration.png)
...
![Real correlation matrix](../../results/biofood_date_region/figures/correlation/correlation_real.png)
![Physics-Informed Monte Carlo correlation matrix](../../results/biofood_date_region/figures/correlation/correlation_physics_mc.png)
![Regression correlation matrix](../../results/biofood_date_region/figures/correlation/correlation_regression.png)
![Variational Autoencoder correlation matrix](../../results/biofood_date_region/figures/correlation/correlation_vae.png)
![Physics-Informed VAE (Hybrid) correlation matrix](../../results/biofood_date_region/figures/correlation/correlation_hybrid_vae.png)

**PCA projection — real vs. each method, plus all combined**

![PCA projection of real vs generated populations](../../results/biofood_date_region/figures/correlation/pca_real_vs_generated.png)

**PCA projection — each population shown individually, no overlay**

![PCA projection of each population individually](../../results/biofood_date_region/figures/correlation/pca_individual.png)

### Marginal distributions (KS)

**KS statistic by feature and method**

![KS statistic heatmap](../../results/biofood_date_region/figures/marginals/ks_heatmap.png)

**Empirical CDFs — real vs. generated, per feature**

![ECDF overlay per feature](../../results/biofood_date_region/figures/marginals/ecdf_overlay.png)

**P-value by feature and method**

![P-value heatmap](../../results/biofood_date_region/figures/marginals/pvalue_heatmap.png)

**Volcano plot — effect size vs. significance**

![Volcano plot](../../results/biofood_date_region/figures/marginals/volcano_plot.png)

---

Raw data: `results/biofood_date_region/summary_metrics.csv`, `results/biofood_date_region/ks_marginals.csv`, `results/biofood_date_region/generalization_gap.csv`, `results/biofood_date_region/synthetic_data/`.
